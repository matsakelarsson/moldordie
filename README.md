...
- Server-rendered frontend with [htmx](https://htmx.org) (via [django-htmx](https://github.com/adamchainz/django-htmx)) and a starter UI library of [django-cotton](https://django-cotton.com) components with project-owned CSS and colour palettes — no Node.js toolchain, no CDN
