...
- Server-rendered frontend with [htmx](https://htmx.org) (via [django-htmx](https://github.com/adamchainz/django-htmx)), styled with [Tailwind CSS](https://tailwindcss.com) and [daisyUI](https://daisyui.com) through [django-tailwind-cli](https://github.com/django-commons/django-tailwind-cli), with the project's own theme to edit — no Node.js toolchain, no CDN and no JavaScript of the project's own
