...
catalogue's defaults with the row's answers on top (Bake in ``CONTEXT.md``). Every test that
needs them gets them here, so that "the defaults" is one statement. So is reading a row written
